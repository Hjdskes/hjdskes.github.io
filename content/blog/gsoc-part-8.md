...
tags = [ "Piper", "fdo", "LED", "DBus", "resolutions", "race condition" ]
...
This blog post is part of a [series](/series/google-summer-of-code/). You can read the next part about the button
